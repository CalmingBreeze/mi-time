...
const calendar = new FullCalendar.Calendar(calendarEl, {
    ...
    selectable: true,
    validRange: function() {
        let startValidDateInterval = moment.tz(timezone);
        let endValidDateIntervalDate = startValidDateInterval.clone().add(3,'months').endOf('month');
        return {
            start: startValidDateInterval.format('YYYY-MM-DD'),
            end: endValidDateIntervalDate.format('YYYY-MM-DD')
        };
    },
